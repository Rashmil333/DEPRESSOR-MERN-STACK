  ...
  const sendMessage = async () => {
	...
	return(<>
				...
				themee=="normal"?"Dchatbackgroundnormal":null} style={{color:'white',height:'800px',color:'grey',}}>
					...
					<img src="https://media1.giphy.com/media/QZVECOeNpquEqnxzi3/giphy.gif" style={{width:'150px'}}/>

					</>


					:live[live.length-1]==live[live.length-2]?
					<img src="https://lh3.googleusercontent.com/proxy/G3Nad0G4hmU_0-Vjd2YMT3rumji8G3E0VjsEiTLYEv9_tFvVdHo1g_vaKPqIUUy3RsQJasN78BGgqN98ey3kTU9gtrWE6GAs9lHTZOcbdZH7oJfWR6vLTck-b_CCYQ" style={{width:'150px'}}/>:<>
					<span>......</span>
