...
const Dyogamyth=()=>{
	...
	return(<>
		<div className="container" style={{textAlign:'justify',color:'white',paddingLeft:'25px',paddingRight:'25px'}} id="selfhealdatadiv">	
		  <div className="row">
			<h1 style={{textAlign:'center',fontSize:'2rem'}} id="text_pink">Myth of Yoga</h1><br/>
					There is a lot of “yoga” happening in the world today that has very little to do with what yoga really is. Several myths about this ancient practice have long been masquerading as facts.<br/>
			<Dcardselfhealing img="https://isha.sadhguru.org/yoga/wp-content/uploads/2017/01/Yoga-Myths.jpg"/><br/><br/>
			<h1 id="text_pink">Myth 1: Yoga comes from Hinduism</h1><br/><br/>
			<Dcardselfhealing img="https://isha.sadhguru.org/blog/wp-content/uploads/2012/11/Yoga-comes-from-Hinduism.jpg"/><br/><br/>
...
Why the yogic sciences have gotten labeled as Hindu by a few ignorant people is because this science and technology grew and prospered in this culture, so naturally it has gotten associated with the Hindu way of life. The word “Hindu” has come from the word “Sindhu”, which is a river. Because this culture grew from the banks of the river Sindhu or Indus, this culture got labeled as Hindu. Hindu is not an “ism” – it is not a religion. It is a geographical and cultural identity.<br/><br/>
<h1 style={{textAlign:'center',fontSize:'2rem'}} id="text_pink">Myth 2: Why be a human when you can be a pretzel? Yoga is all about impossible postures.</h1><br/>
<Dcardselfhealing img="https://isha.sadhguru.org/blog/wp-content/uploads/2012/11/impossible-postures.jpg"/><br/><br/>
...
The first part of Shiva’s teaching was to Parvati, his wife. The second set of yoga teachings were expounded to the first seven disciples. This happened at the banks of Kanti Sarovar at Kedarnath. This is where the world’s first yoga program happened.<br/><br/>
...
<h1 style={{textAlign:'center',fontSize:'2rem'}} id="text_pink"> Myth 5: Find your groove. Yoga & music go well.
</h1><br/>
<Dcardselfhealing img="https://isha.sadhguru.org/blog/wp-content/uploads/2012/11/usicyoga.jpg"/><br/><br/>
...
A lot of people who have done improper yoga have lost their mental balance. This is not because yoga is dangerous. Stupidity has always been a dangerous thing on the planet. You do something stupid, it will cause damage to you. Stupidity is one thing which has always been a dangerous thing on this planet, right from ancient times.<br/><br/>
<h1 style={{textAlign:'center',fontSize:'2rem'}} id="text_pink">Myth 6: Need a yoga study guide? You can learn yoga from a book. </h1><br/>
<Dcardselfhealing img="https://isha.sadhguru.org/blog/wp-content/uploads/2012/11/bookyoga.jpg"/><br/><br/>
Today, if you enter any major bookstore, you will find a minimum of 15 to 20 different yoga books. How to learn yoga in 7 days, how to become a yogi in 21 days… Many people have caused immense damage to themselves by learning yoga through books. It seems to be very simple, but when you do it, you will see it is a very subtle aspect. This has to be done with perfect understanding and proper guidance. Without this, one can get into deep trouble. A book can inspire you, but it is not meant to teach a practice.<br/><br/>
<h1 style={{textAlign:'center',fontSize:'2rem'}} id="text_pink"> Myth 7: Yoga is something you practice every morning and evening</h1><br/>
<Dcardselfhealing img="https://isha.sadhguru.org/blog/wp-content/uploads/2012/11/5528924030_0415bc00b4_z.jpg"/><br/><br/>
