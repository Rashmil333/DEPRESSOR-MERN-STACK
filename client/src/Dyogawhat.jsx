...
const Dyogawhat=()=>{
	...
	return(<>
		<div className="container" style={{textAlign:'justify',paddingLeft:'25px',paddingRight:'25px'}} id="selfhealdatadiv">	
		  <div className="row">
			<h1 style={{textAlign:'center'}} id="text_pink">What is Yoga</h1><br/>
			<p id="text_white">What is Yoga, exactly? Is it just an exercise form? Is it a religion, a philosophy, an ideology? Or is it something else entirely? The word "Yoga" literally means "union". In this article, Sadhguru offers the following Yoga definition; essentially, "that which brings you to reality."</p>
			
			<Dcardselfhealing img="https://isha.sadhguru.org/yoga/wp-content/uploads/2020/05/meaning-of-yoga.jpg"/>
			<br/><br/><br/>
			<p id="text_white">Essentially in the tradition, once we attach the word “Yoga” to anything, it indicates that it is a complete path by itself. We say hatha Yoga, but we will not say asana Yoga. Of course, if you come from the United States, they say anything!</p>
