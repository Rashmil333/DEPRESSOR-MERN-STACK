...
const Dyogahistory=()=>{
	...
	return(<>
		<div className="container" style={{textAlign:'justify',color:'white',paddingLeft:'25px',paddingRight:'25px'}} id="selfhealdatadiv">	
		  <div className="row">
			<h1 style={{textAlign:'center'}} id="text_pink">History of Yoga</h1><br/>
