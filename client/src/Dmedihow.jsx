...
const Dmedihow=()=>{
	...
	return(<>
		<div className="container" style={{textAlign:'justify',color:'white',paddingLeft:'25px',paddingRight:'25px'}} id="selfhealdatadiv">	
		  <div className="row">
			<h1 style={{textAlign:'center'}} id="text_pink">How to Meditate</h1><br/>
				<Dcardselfhealing img="https://isha.sadhguru.org/yoga/wp-content/uploads/2020/05/How-to-Meditate.jpg"/><br/><br/>
...
<h3 style={{textAlign:'center'}} id="text_pink">Meditation and the Mind</h3><br/><br/>
