				...
				<div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
				 <div className="row">
			      ...
			      <form method="POST">
					...
					<input id="phone" type="number" placeholder={props.phone} cclassName="profile_input"name="mobile_no" value={state.mobile_no} onChange={inputevent}/><br/>
					...
					<input id="code" className="profile_input" type="text" placeholder="Write the code" onChange={setvalues}/><br/><br/>
						<div className="container">
							<div className="row">
								...
								<div className="col-xl-6 col-md-6 col-lg-6 col-sm-6 col-6">
									<Button type="submit" style={{backgroundColor:'pink',marginLeft:'40px'}} onClick={postdata}  >Update</Button>
								</div>
							</div>
						</div>
